//! EntryStore implementation for SQLite storage.

use super::sqlite::SqliteStorage;
use crate::domain::{AgeIdentity, AgeRecipient, Entry, EntryType, Field, FieldType};
...
#[async_trait]
impl<C> EntryStore for SqliteStorage<C>
where
